...
namespace Componentes_com_ASP.NET
{
    public partial class Panell_e_BulleList : System.Web.UI.Page
    {
        ...
        protected void list_Click(object sender, BulletedListEventArgs action)
        {
            numPI.Visible = false;
        ...
        protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs action)
        {
            String txt = "";
